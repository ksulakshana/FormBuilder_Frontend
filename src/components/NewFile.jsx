...
function NewFile({ sendDataBack, props }) {
  ...
  const [formId, setFormId] = useState(props);
  ...
  }, [dataFields, inputRef, inputValue, steps, file]);
                ...
                <div className={styles.bubbleDiv}>
                  {value1.fieldName === "text" ? (
                    ...
                    <>
                      ...
                      >
                        {file && (
                          <span name={"bubbleImage_" + index}>{file.name}</span>
                        )}
                        {!file && (
